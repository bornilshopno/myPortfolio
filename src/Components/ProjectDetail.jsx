    ...
    <div>
      {project ? (
        <div className="bg-gray-700 text-gray-200">
          <h2 className="text-xl font-bold text-center bg-gray-700 text-gray-200 pt-3 lg:py-5">
            Project Details: {project.projectName}
            <br />
            <span className="text-thin text-base"> {project.shortDescription}</span>
          </h2>

          <h2 className="mx-auto w-10/12 max-w-screen-md text-center py-2 lg:py-10">
            {project.description}
          </h2>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-4 w-11/12 mx-auto pb-5">
            <div className="hidden lg:block h-[90vh] overflow-y-auto">
              ...
              />
              {imageLoading && (
                <div className="m-auto"> <span className="loading loading-ring loading-lg"></span></div> // Replace with your spinner component
              )}
            </div>
            <div>
              <h2>
                ...
                <ul className="flex flex-wrap">
                  {project.technology.map((tech, index) => (
                    <li className="flex gap-1 mr-2 items-center" key={index}>
                      <SiListmonk />
                      {tech}
                    </li>
                  ))}
